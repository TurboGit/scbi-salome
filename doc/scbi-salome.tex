...
\begin{description}
	\item[v95] To build SALOME v9.5, the build plan contains the following modules:

	Environment \file{.env-v95}:
	\lstinputlisting{"../scripts.d/.env-v95"}

	Plan \file{.plan-v95}:
	\lstinputlisting{"../scripts.d/.plan-v95"}

	Note the use of the \code{ospray} and \code{gdal} variant for \code{paraview} module.
